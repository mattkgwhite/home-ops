...
Crossplane is an open-source control plane framework that extends Kubernetes to manage and provision cloud infrastructure and services through declarative APIs. It lets platform teams build custom control planes and orchestrate resources across providers using familiar Kubernetes tooling. :contentReference[oaicite:0]{index=0}
